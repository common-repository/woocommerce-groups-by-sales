...
class WooGroupsBySales_Plugin {
	...
	public static function register_woogroupsbysales_settings() {
		...
		register_setting( 'woogroupsbysales', 'wgbsales-levels' );
		
		add_option( 'wgbsales-method', 'total' ); // default method used.
	...
	if ( isset( $_POST['submit'] ) ) {
		...
		if ( isset( $_POST[ "wgbsales-method" ] ) ) {
			update_option( "wgbsales-method", $_POST[ "wgbsales-method" ] );
		}
	}
	...
	$method = get_option( "wgbsales-method", "total" );
	...
	<form method="post" action="">
		...
		<tr valign="top">
		<th scope="row"><?php echo __( "Method:", WOO_GROUPS_BY_SALES_DOMAIN ) ?></th>
		<td>
		
			<select name="wgbsales-method">
				<option value="total" <?php echo ( $method == "total" ) ? "selected" : ""; ?> ><?php echo __("Total amount", WOO_GROUPS_BY_SALES_DOMAIN);?></option>
				<option value="orders" <?php echo ( $method == "orders" ) ? "selected" : ""; ?> ><?php echo __("Num. Orders", WOO_GROUPS_BY_SALES_DOMAIN);?></option>
			</select>
		</td>
		</tr>
